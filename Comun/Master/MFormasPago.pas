...
begin
  ...
  begin
    ...
    raise Exception.Create('Falta la forma de pago de X3.');
  end;

  if banco_x3_fp.Text <> '' then
    if Length(banco_x3_fp.Text) <> 5 then
    begin
      banco_x3_fp.SetFocus;
      raise Exception.Create('El código de banco para X3 debe ser de 5 caracteres');
    end;
