...
begin
  ...
  begin
    ...
    QEstadoCobros.SQL.Add('     from   tremesas_fac join  tremesas_cab on empresa_remesa_rc = empresa_remesa_rf and n_remesa_rc = n_remesa_rf and fecha_remesa_rf = fecha_remesa_rc ');
