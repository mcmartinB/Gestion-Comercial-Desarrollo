...
//    btnAMAnterior: TToolButton;
    ...
    procedure mnuFchFlotaCamionesClick(Sender: TObject);
...
uses
  ...
  CMaestroDetalle, bDialogs, bFileUtils, BEdit, DError, AccesoUsuarioFD,
...
begin
  ...
  ConfigurarOpcion(  mnuFacListadoResemasBanco, bPuedoFacturar, 'Listado de Cobros por Banco', '');
...
procedure TFPrincipal.mnuFchFlotaCamionesClick(Sender: TObject);
begin
  CUAMenuFicheros.EjecutarMenuFicheros( self, TMenuItem( Sender ).Name );
end;
